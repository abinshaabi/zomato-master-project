  ...
  return (
    <div className=" w-full  p-4 md:w-1/2 lg:w-1/3">
      <div className="w-full h-full bg-white rounded-2xl shadow-lg ">
        <div className={`w-full p-4 h-56 md:h-64 rounded-t-2xl bg-${props.bg}-100`}>
        ...
        <div className="p-3 flex flex-col gap-3">
          ...
          <p className="text-normal font-light text-gray-400">
          ...
          <div>
            ...
            <p className="text-normal font-light text-gray-400">Monthly pack - 30 capsules</p>
          </div>
        </div>
      </div>
    </div>
